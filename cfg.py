...
def get_cfg():
    ...
    parser.add_argument("--epoch", type=int, default=300, help="total epoch number")
    parser.add_argument(
        "--eval_every_drop",
        type=int,
        default=5,
    ...
    parser.add_argument("--yeta", type=int, default=20)
    parser.add_argument("--lambda1", type=float, default=1)
    parser.add_argument("--lambda2", type=float, default=0.01)
    parser.add_argument("--temperature", type=float, default=0.5)
    parser.add_argument("--IL",type=int, default=0)
    ...
    parser.add_argument("--eval-type", type=str, default="512-last")
